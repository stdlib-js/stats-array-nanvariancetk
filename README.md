...
```javascript
import nanvariancetk from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-array-nanvariancetk@v0.1.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/stats-array-nanvariancetk/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-array-nanvariancetk/actions/workflows/test.yml?query=branch:v0.1.0
